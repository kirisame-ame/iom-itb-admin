...
ARG VUE_APP_BANKES_DASHBOARD_API_URL
ARG VUE_APP_OTA_DASHBOARD_API_URL
...
ENV VUE_APP_BANKES_DASHBOARD_API_URL=${VUE_APP_BANKES_DASHBOARD_API_URL}
ENV VUE_APP_OTA_DASHBOARD_API_URL=${VUE_APP_OTA_DASHBOARD_API_URL}
