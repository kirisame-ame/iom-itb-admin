  ...
  <div class="flex">
    ...
    >
      ...
      <nav class="mt-10">
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Kegiatan' ? activeClass : inactiveClass]"
          to="/kegiatan"
        >
          <IcGrafic/>
          <span class="mx-4">Kegiatan</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Merchandise' ? activeClass : inactiveClass]"
          to="/merchandise"
        >
          <IcBag/>
...
<!-- 
        ...
        >
          <IcUser/>
          <span class="mx-4">Pengajuan Bantuan</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Pendataan Anggota' ? activeClass : inactiveClass]"
          to="/pendataan-anggota"
        >
          <IcUser/>
          <span class="mx-4">Pendataan Anggota</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Orangtua Asuh' ? activeClass : inactiveClass]"
          to="/orangtua-asuh"
        >
          <IcUser/>
          <span class="mx-4">Orangtua Asuh</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Dana Bantuan' ? activeClass : inactiveClass]"
          to="/dana-bantuan"
        >
          <IcCard/>
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'Broadcast' ? activeClass : inactiveClass]"
          to="/broadcast"
        >
          <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6 6 0 10-12 0v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
          </svg>
          <span class="mx-4">Broadcast</span>
        </router-link>
